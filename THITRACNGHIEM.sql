...
-- =============================================
-- 1. BANG DANH MUC (Khong co khoa ngoai)
-- =============================================
...
CREATE TABLE [dbo].[MONHOC](
 ...
 CONSTRAINT [PK_TENMH] PRIMARY KEY CLUSTERED ([MAMH] ASC)
	WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
 CONSTRAINT [CK_MONHOC_MAMH_UPPER] CHECK ([MAMH] COLLATE Latin1_General_BIN2 = UPPER([MAMH]) COLLATE Latin1_General_BIN2)
) ON [PRIMARY]
GO
...
-- =============================================
-- 2. BANG NGHIEP VU (Co khoa ngoai)
-- =============================================
CREATE TABLE [dbo].[SINHVIEN](
	...
	[TrangThai] [bit] NOT NULL CONSTRAINT [DF_SINHVIEN_TrangThai] DEFAULT ((1)),
 CONSTRAINT [PK_SINHVIEN] PRIMARY KEY CLUSTERED ([MASV] ASC)
	WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
 CONSTRAINT [FK_SINHVIEN_LOP] FOREIGN KEY([MALOP]) REFERENCES [dbo].[LOP] ([MALOP]) ON UPDATE CASCADE,
 CONSTRAINT [CK_SINHVIEN_NGAYSINH] CHECK ([NGAYSINH] IS NULL OR ([NGAYSINH] > '1900-01-01' AND [NGAYSINH] < GETDATE()))
) ON [PRIMARY]
GO
...
CREATE TABLE [dbo].[BANGDIEM](
	...
	[NGAYTHI] [date] NULL DEFAULT (GETDATE()),
	[DIEM] [float] NULL,
 CONSTRAINT [PK_BANGDIEM] PRIMARY KEY CLUSTERED ([MASV] ASC, [MAMH] ASC, [LAN] ASC)
	WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
 CONSTRAINT [FK_BANGDIEM_MONHOC] FOREIGN KEY([MAMH]) REFERENCES [dbo].[MONHOC] ([MAMH]),
 CONSTRAINT [FK_BANGDIEM_SINHVIEN1] FOREIGN KEY([MASV]) REFERENCES [dbo].[SINHVIEN] ([MASV]) ON UPDATE CASCADE,
 CONSTRAINT [CK_DIEM] CHECK (([DIEM]>=(0) AND [DIEM]<=(10))),
 CONSTRAINT [CK_LANTHI] CHECK (([LAN]>=(1) AND [LAN]<=(2)))
) ON [PRIMARY]
GO
...
CREATE TABLE [dbo].[BODE](
	...
	[DAP_AN] [char](1) NULL,
	[MAGV] [nchar](8) NULL,
	[TrangThai] [bit] NOT NULL CONSTRAINT [DF_BODE_TrangThai] DEFAULT ((1)),
 CONSTRAINT [PK_BODE] PRIMARY KEY CLUSTERED ([CAUHOI] ASC)
	WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
 CONSTRAINT [FK_BODE_GIAOVIEN] FOREIGN KEY([MAGV]) REFERENCES [dbo].[GIAOVIEN] ([MAGV]),
 CONSTRAINT [FK_BODE_MONHOC] FOREIGN KEY([MAMH]) REFERENCES [dbo].[MONHOC] ([MAMH]),
 CONSTRAINT [CK_BODE] CHECK (([TRINHDO]='A' OR [TRINHDO]='B' OR [TRINHDO]='C')),
 CONSTRAINT [CK_DAPAN] CHECK (([DAP_AN]='D' OR ([DAP_AN]='C' OR ([DAP_AN]='B' OR [DAP_AN]='A'))))
) ON [PRIMARY]
GO
...
CREATE TABLE [dbo].[GIAOVIEN_DANGKY](
 ...
 CONSTRAINT [PK_GIAOVIEN_DANGKY] PRIMARY KEY CLUSTERED ([MAMH] ASC, [MALOP] ASC, [LAN] ASC)
	WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
 CONSTRAINT [FK_GIAOVIEN_DANGKY_LOP] FOREIGN KEY([MALOP]) REFERENCES [dbo].[LOP] ([MALOP]),
 CONSTRAINT [FK_GIAOVIEN_DANGKY_MONHOC1] FOREIGN KEY([MAMH]) REFERENCES [dbo].[MONHOC] ([MAMH]),
 CONSTRAINT [CK_LAN] CHECK (([LAN]>=(1) AND [LAN]<=(2))),
 CONSTRAINT [CK_SOCAUTHI] CHECK (([SOCAUTHI]>=(10) AND [SOCAUTHI]<=(100))),
 CONSTRAINT [CK_THOIGIAN] CHECK (([THOIGIAN]>=(5) AND [THOIGIAN]<=(60))),
 CONSTRAINT [CK_TRINHDO] CHECK (([TRINHDO]='C' OR ([TRINHDO]='B' OR [TRINHDO]='A')))
) ON [PRIMARY]
GO
...
CREATE TABLE dbo.CT_DETHI (
    ...
    LAN smallint NOT NULL,
    CAUHOI int NOT NULL,
    CONSTRAINT PK_CT_DETHI PRIMARY KEY (MAMH, MALOP, LAN, CAUHOI),
    CONSTRAINT FK_CT_DETHI_GVDangKy FOREIGN KEY (MAMH, MALOP, LAN)
        REFERENCES dbo.GIAOVIEN_DANGKY(MAMH, MALOP, LAN)
        ON DELETE CASCADE,
    CONSTRAINT FK_CT_DETHI_BODE FOREIGN KEY (CAUHOI)
...
CREATE TABLE dbo.BAITHI (
    ...
    CONSTRAINT FK_BAITHI_SINHVIEN FOREIGN KEY (MASV)
        REFERENCES dbo.SINHVIEN(MASV),

    CONSTRAINT FK_BAITHI_GVDANGKY FOREIGN KEY (MAMH, MALOP, LAN)
        REFERENCES dbo.GIAOVIEN_DANGKY(MAMH, MALOP, LAN),

    CONSTRAINT CK_BAITHI_LAN CHECK (LAN >= 1 AND LAN <= 2)
) ON [PRIMARY]
GO
...
CREATE TABLE dbo.CT_BAITHI (
    ...
    CONSTRAINT PK_CT_BAITHI PRIMARY KEY CLUSTERED (MASV ASC, MAMH ASC, LAN ASC, CAUHOI ASC)
        WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF,
              ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],

    CONSTRAINT FK_CT_BAITHI_BAITHI FOREIGN KEY (MASV, MAMH, LAN)
        REFERENCES dbo.BAITHI(MASV, MAMH, LAN)
        ON DELETE CASCADE,

    CONSTRAINT FK_CT_BAITHI_BODE FOREIGN KEY (CAUHOI)
        REFERENCES dbo.BODE(CAUHOI),
...
-- 3. INDEXES
-- =============================================
CREATE NONCLUSTERED INDEX [IX_BODE_MAGV] ON [dbo].[BODE] ([MAGV] ASC);
GO
CREATE NONCLUSTERED INDEX [IX_BODE_MAMH_TRINHDO] ON [dbo].[BODE] ([MAMH] ASC, [TRINHDO] ASC);
GO
CREATE NONCLUSTERED INDEX [IX_SINHVIEN_MALOP] ON [dbo].[SINHVIEN] ([MALOP] ASC);
GO
CREATE NONCLUSTERED INDEX [IX_BODE_MAGV_MAMH] ON [dbo].[BODE] ([MAGV] ASC, [MAMH] ASC);
GO

CREATE NONCLUSTERED INDEX [IX_BODE_MAGV_CAUHOI] ON [dbo].[BODE] ([MAGV] ASC, [CAUHOI] ASC)
INCLUDE ([MAMH], [TRINHDO], [DAP_AN]);
GO

CREATE NONCLUSTERED INDEX [IX_BODE_MAGV_MAMH_CAUHOI] ON [dbo].[BODE] ([MAGV] ASC, [MAMH] ASC, [CAUHOI] ASC)
INCLUDE ([TRINHDO], [DAP_AN]);
GO

CREATE NONCLUSTERED INDEX [IX_BODE_MAMH_TRINHDO_CAUHOI] ON [dbo].[BODE] ([MAMH] ASC, [TRINHDO] ASC, [CAUHOI] ASC)
INCLUDE ([DAP_AN], [MAGV]);
GO
CREATE NONCLUSTERED INDEX [IX_BODE_TrangThai_MAGV_CAUHOI] ON [dbo].[BODE] ([TrangThai] ASC, [MAGV] ASC, [CAUHOI] ASC)
INCLUDE ([MAMH], [TRINHDO], [DAP_AN]);
GO
CREATE NONCLUSTERED INDEX [IX_BODE_TrangThai_MAMH_TRINHDO_CAUHOI] ON [dbo].[BODE] ([TrangThai] ASC, [MAMH] ASC, [TRINHDO] ASC, [CAUHOI] ASC)
INCLUDE ([DAP_AN], [MAGV]);
GO
CREATE NONCLUSTERED INDEX [IX_BODE_DuplicateCheck] ON [dbo].[BODE] ([TrangThai] ASC, [MAMH] ASC, [TRINHDO] ASC)
INCLUDE ([CAUHOI], [NOIDUNG], [A], [B], [C], [D]);
GO
CREATE NONCLUSTERED INDEX [IX_SINHVIEN_TrangThai_MASV] ON [dbo].[SINHVIEN] ([TrangThai] ASC, [MASV] ASC);
GO
CREATE NONCLUSTERED INDEX [IX_LOP_TrangThai_MALOP] ON [dbo].[LOP] ([TrangThai] ASC, [MALOP] ASC);
GO
CREATE NONCLUSTERED INDEX [IX_LOP_TrangThai_TENLOP] ON [dbo].[LOP] ([TrangThai] ASC, [TENLOP] ASC) INCLUDE ([MALOP]);
GO
CREATE NONCLUSTERED INDEX [IX_MONHOC_TrangThai_TENMH] ON [dbo].[MONHOC] ([TrangThai] ASC, [TENMH] ASC)
INCLUDE ([MAMH]);
GO
CREATE NONCLUSTERED INDEX [IX_SINHVIEN_MALOP_TrangThai] ON [dbo].[SINHVIEN] ([MALOP] ASC, [TrangThai] ASC, [MASV] ASC)
INCLUDE ([HO], [TEN], [NGAYSINH], [DIACHI], [MATKHAU]);
GO
CREATE NONCLUSTERED INDEX [IX_SINHVIEN_TrangThai_TEN_HO] ON [dbo].[SINHVIEN] ([TrangThai] ASC, [TEN] ASC, [HO] ASC, [MASV] ASC)
INCLUDE ([NGAYSINH], [DIACHI], [MALOP], [MATKHAU]);
GO
CREATE NONCLUSTERED INDEX [IX_SINHVIEN_TrangThai_HO_TEN] ON [dbo].[SINHVIEN] ([TrangThai] ASC, [HO] ASC, [TEN] ASC, [MASV] ASC)
INCLUDE ([NGAYSINH], [DIACHI], [MALOP], [MATKHAU]);
GO

CREATE NONCLUSTERED INDEX [IX_GIAOVIEN_TrangThai_HO_TEN] ON [dbo].[GIAOVIEN] ([TrangThai] ASC, [HO] ASC, [TEN] ASC, [MAGV] ASC)
INCLUDE ([SODTLL], [DIACHI]);
GO
CREATE NONCLUSTERED INDEX [IX_GIAOVIEN_DANGKY_MALOP] ON [dbo].[GIAOVIEN_DANGKY] ([MALOP] ASC);
GO
...
CREATE NONCLUSTERED INDEX IX_MONHOC_TrangThai_MAMH
ON dbo.MONHOC (TrangThai, MAMH)
INCLUDE (TENMH);
GO

CREATE NONCLUSTERED INDEX [IX_BAITHI_MASV_TRANGTHAI] ON [dbo].[BAITHI] ([MASV] ASC, [TRANGTHAI] ASC)
INCLUDE ([MAMH], [LAN], [MALOP], [THOIDIEMBATDAU]);
GO

CREATE NONCLUSTERED INDEX [IX_CT_BAITHI_STT] ON [dbo].[CT_BAITHI] ([MASV] ASC, [MAMH] ASC, [LAN] ASC, [STT] ASC)
INCLUDE ([CAUHOI], [CAUTRALOI]);
GO
