...
CREATE NONCLUSTERED INDEX [IX_BODE_DuplicateCheck] ON [dbo].[BODE] ([MAMH] ASC, [TRINHDO] ASC)
INCLUDE ([CAUHOI], [NOIDUNG], [A], [B], [C], [D]);
GO
CREATE NONCLUSTERED INDEX [IX_SINHVIEN_MALOP_INCLUDE] ON [dbo].[SINHVIEN] ([MALOP] ASC, [MASV] ASC)
INCLUDE ([HO], [TEN], [NGAYSINH], [DIACHI], [MATKHAU]);
GO
CREATE NONCLUSTERED INDEX [IX_SINHVIEN_TEN_HO] ON [dbo].[SINHVIEN] ([TEN] ASC, [HO] ASC, [MASV] ASC)
INCLUDE ([NGAYSINH], [DIACHI], [MALOP], [MATKHAU]);
GO
CREATE NONCLUSTERED INDEX [IX_SINHVIEN_HO_TEN] ON [dbo].[SINHVIEN] ([HO] ASC, [TEN] ASC, [MASV] ASC)
INCLUDE ([NGAYSINH], [DIACHI], [MALOP], [MATKHAU]);
GO

CREATE NONCLUSTERED INDEX [IX_GIAOVIEN_HO_TEN] ON [dbo].[GIAOVIEN] ([HO] ASC, [TEN] ASC, [MAGV] ASC)
